...
| Image | Role |
| --- | --- |
| <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/python/python-original.svg" alt="Python" width="32"> | Langage utilise pour ecrire les fonctions, lancer le programme et manipuler les donnees. |
| <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/sqlalchemy/sqlalchemy-original.svg" alt="SQLAlchemy" width="32"> | ORM Python cible du projet : il permet de manipuler des tables SQL avec du code Python. |
| <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/sqlite/sqlite-original.svg" alt="SQLite" width="32"> | Base de donnees locale, stockee dans le fichier `sqlalchemy_training.db`. |
